...
\pagebreak
\subsection{Modules}
The Communicator is the interface exposed by GCom to the Application layer. On
its creation the application layer provides the appropriate GCom settings as
well as a callback to execute when a message is received. 
